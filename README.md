...
To run the program, follow these steps:
   ...
   -  Navigate to the project directory and set the CONFIG_PATH environment variable to the correct path of the config.ini file.

```bash
 export CONFIG_PATH=/path/to/config.ini # Please provide the correct path to the config.ini file.
```
