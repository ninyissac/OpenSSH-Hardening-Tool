...
from security_hardener.src.generalserver import actions

def harden():

    pl = parse_template(ctx=context_config["generalserver"])
    pc = parse_compiler(ctx=context_config["generalserver"])
    ps = parse_template(ctx=context_config["generalserver"], parse_file="system")
